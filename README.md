...
Команда разработки:
- Первый разработчик [Настя (в роли Python-разработчика Тимлид команды - разработчик 1)](https://github.com/nastasiatr)
- Второй разработчик [EvgeniyYakovlev1198 (в роли Python-разработчика - разработчик 2)](https://github.com/EvgeniyYakovlev1198)
- Третий разработчик [Andrewraush (в роли Python-разработчика - разработчик 3)](https://github.com/Andrewraush)
